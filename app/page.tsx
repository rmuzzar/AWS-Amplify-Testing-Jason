...
export default async function Home() {
  ...
  return (
    <main>
        ...
        {data ? (
          <>
            <h1 className={styles['text']}>Ctrl Alt Elt: {data.success[0].teamNumber}<br></br>Version: {data.success[0].VersionNum}<br></br>Date: {data.success[0].SprintDate}<br></br>Product: {data.success[0].ProductName}<br></br>Description: {data.success[0].ProductDescription} </h1>
